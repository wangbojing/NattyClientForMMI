...
#Update By WangBoJing add Natty Protocol
ifdef USE_NATTY_PROTOCOL
ifeq ($(strip $(USE_NATTY_PROTOCOL)),TRUE)
COM_DEFS   += __USE_NATTY_PROTOCOL__
COM_DEFS   += __USE_NATTY_SSL__
COM_DEFS += NATTY_PROTOCOL_VERSION=0x41
#don't use i-look protocol
USE_YX_ONLY_SIMCARD_NUMBER = TRUE
endif
endif

ifdef USE_YX_ONLY_SIMCARD_NUMBER
ifeq ($(strip $(USE_YX_ONLY_SIMCARD_NUMBER)),TRUE)
COM_DEFS   += __USE_YX_ONLY_SIMCARD_NUMBER__
endif
endif

USE_YX_APP_SERVICE = TRUE
ifdef USE_YX_APP_SERVICE
  ifeq ($(strip $(USE_YX_APP_SERVICE)),TRUE)
    COM_DEFS    += __USE_YX_APP_SERVICE__
  endif
endif

ifdef USE_YX_AUTO_TEST
ifeq ($(strip $(USE_YX_AUTO_TEST)),TRUE)
COM_DEFS   += __USE_YX_AUTO_TEST__
COM_DEFS += TEST_MTK_PLATFORM_VERSION=0x11C0
COMPOBJS += plutommi\yxtest\testmain.a
COMPOBJS += plutommi\yxtest\testplatform.a
endif
endif
